$(function() {
	...
	c.load("<div class='bef_comment writecode'>&nbsp;*hi,我的名字叫Ikaros，是西纳普斯的人造天使</div>");
	c.load("<div class='bef_comment writecode'>&nbsp;*我是玩赏用人造天使</div>",2000);
	...
	w.load("<p><div class='writecode'>Ikaros</div>");
	w.load("<div class='writecode'>人造天使(西纳普斯)</div>");
	w.load("<div class='writecode'>玩赏用人造天使</div></p>");
	w.load("<h1 class='writecode'>联系我</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>mail:327209194@qq.com</li>");
	w.load("<li class='writecode'>blog:<a href='https://ikaros-521.github.io/' target='_blank'>https://ikaros-521.github.io/</a></li>");
	w.load("<li class='writecode'>github:<a href='https://github.com/Ikaros-521' target='_blank'>https://github.com/Ikaros-521</a></li>");
	w.load("</ul>");
	w.load("<h1 class='writecode'>技能</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>精通各种技术</li>");
	w.load("</ul>");
